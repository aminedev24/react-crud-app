        ...
        !(function (e) {
            function t(e, r) {
                ...
                if (void 0 !== r) {
                    ...
                    d
                        ...
                        p && ((u = m.port), (l = m.hostname), (s = m.host), (i = m.password), (o = m.username)),
                        a || (a = m.protocol);
                }
                (d = d.replace(/\\/g, "/")),
            ...
            (function (e) {
                ...
                function c(e, t) {
                    ...
                    } else if ("/" != e[0] && -1 == e.indexOf(":")) return ((t && t.substr(0, t.lastIndexOf("/") + 1)) || J) + e;
                    return new G(e, (t && t.replace(/#/g, "%05")) || ee).href.replace(/%05/g, "#");
                }
                function f(e, t) {
                    var r,
                        n = "",
                ...
                function y(e, t, r, n, a) {
                    for (var o in t)
                        if (-1 != $.call(["main", "format", "defaultExtension", "basePath"], o)) e[o] = t[o];
                        else if ("map" == o) g((e.map = e.map || {}), t.map);
                        else if ("meta" == o) g((e.meta = e.meta || {}), t.meta);
                        else if ("depCache" == o)
                            for (var i in t.depCache) {
                                var s;
                                (s = "./" == i.substr(0, 2) ? r + "/" + i.substr(2) : M.call(n, i)), (n.depCache[s] = (n.depCache[s] || []).concat(t.depCache[i]));
                            }
                        else
                            !a ||
                                -1 != $.call(["browserConfig", "nodeConfig", "devConfig", "productionConfig"], o) ||
                ...
                function b(e, t, r, n) {
                    ...
                    if (e.packages[t]) {
                        var o = e.packages[t];
                        (a = e.packages[t] = {}), y(a, n ? r : o, t, e, n), y(a, n ? o : r, t, e, !n);
                ...
                function I(e) {
                    ...
                    return (
                        -1 != a
                            ? ((t = e.substr(a + 1)), (r = e.substr(n, a - n)), n && w.call(this, 'Condition negation form "' + e + '" is deprecated for "' + r + "|~" + t + '"'), "~" == t[0] && ((n = !0), (t = t.substr(1))))
                            : ((t = "default"), (r = e.substr(n)), -1 != ue.indexOf(r) && ((t = r), (r = null))),
                ...
                function L(e, t, r) {
                    ...
                    return this.normalize(e.module, t).then(function (t) {
                        return n.load(t).then(function (a) {
                            ...
                            if (r && "boolean" != typeof o) throw new TypeError("Condition " + T(e) + " did not resolve to a boolean.");
                            return e.negate ? !o : o;
                        });
                    });
                }
                ...
                if (J) (J = J.split("#")[0].split("?")[0]), (J = J.substr(0, J.lastIndexOf("/") + 1));
                else {
                    ...
                    (function () {
                                ...
                                return "loading" == t.status
                                    ? ((t.address = t.address || t.name),
                                      Promise.resolve(e.loaderObj.translate({ name: t.name, metadata: t.metadata, address: t.address, source: r }))
                                          ...
                                          .then(function () {
                                              t.dependencies = [];
                                              for (var r = t.depsList, n = [], a = 0, i = r.length; i > a; a++)
                                                  (function (r, a) {
                                                      n.push(
                                                          o(e, r, t.name, t.address).then(function (e) {
                                                              if (((t.dependencies[a] = { key: r, value: e.name }), "linked" != e.status)) for (var n = t.linkSets.concat([]), o = 0, i = n.length; i > o; o++) c(n[o], e);
                                                          })
                                                      );
                                                  })(r[a], a);
                        ...
                        function u(t) {
                            return function (r, n) {
                                ...
                                for (var c, f = 0, m = a.loads.length; m > f; f++)
                                    if (
                                        a.loads[f].name == o &&
                                        ((c = a.loads[f]), "translate" != u || c.source || ((c.address = t.moduleAddress), l(a, c, Promise.resolve(t.moduleSource))), c.linkSets.length && c.linkSets[0].loads[0].name == c.name)
                                    )
                        ...
                        function p(e, r, n) {
                            ...
                            for (var u = e.loads.concat([]), o = 0, d = u.length; d > o; o++) {
                                var r = u[o];
                                (a.loaderObj.failed = a.loaderObj.failed || []), -1 == $.call(a.loaderObj.failed, r) && a.loaderObj.failed.push(r);
                        ...
                        function h(e, t) {
                            ...
                            for (var a = 0, o = t.linkSets.length; o > a; a++) (n = $.call(t.linkSets[a].loads, t)), -1 != n && t.linkSets[a].loads.splice(n, 1);
                        ...
                        n.prototype = {
                            ...
                            define: function (e, t, r) {
                                ...
                                return v(this, e, new Promise(u({ step: "translate", loader: this._loader, moduleName: e, moduleMetadata: (r && r.metadata) || {}, moduleSource: t, moduleAddress: r && r.address })));
                            },
                            delete: function (e) {
                                var t = this._loader;
                                ...
                                return t.modules[e]
                                    ...
                                    : (
                                          ...
                                          v(
                                              this,
                                              e,
                                              new Promise(u({ step: "locate", loader: t, moduleName: e, moduleMetadata: {}, moduleSource: void 0, moduleAddress: void 0 })).then(function (r) {
                                                  return delete t.importPromises[e], r.module.module;
                                              })
                                          )
                                      ).then(function () {});
                ...
                if ("undefined" != typeof XMLHttpRequest)
                    W = function (e, t, r, n) {
                        ...
                        s || "undefined" == typeof XDomainRequest || ((i = new XDomainRequest()), (i.onload = a), (i.onerror = o), (i.ontimeout = o), (i.onprogress = function () {}), (i.timeout = 0), (l = !0)),
                            (i.onreadystatechange = function () {
                                4 === i.readyState && (0 == i.status ? (i.responseText ? a() : (i.addEventListener("error", o), i.addEventListener("load", a))) : 200 === i.status ? a() : o());
                            }),
                            i.open("GET", e, !0),
                            i.setRequestHeader && (i.setRequestHeader("Accept", "application/x-es-module, */*"), t && ("string" == typeof t && i.setRequestHeader("Authorization", t), (i.withCredentials = !0))),
                            l
                                ? setTimeout(function () {
                                      i.send();
                                  }, 0)
                ...
                !(function () {
                    ...
                    re = function (e) {
                        if (e.source) {
                            if ((e.metadata.integrity || e.metadata.nonce) && g) return s.call(this, e);
                            try {
                                a(this, e),
                                    (d = e),
                                    !p && this._nodeRequire && ((p = this._nodeRequire("vm")), (m = p.runInThisContext("typeof System !== 'undefined' && System") === this)),
                                    m ? p.runInThisContext(n(e, !0), { filename: e.address + (e.metadata.sourceMap ? "!transpiled" : "") }) : (0, eval)(n(e, !0)),
                                    o();
                            } catch (r) {
                    ...
                    var g = !1;
                    D && "undefined" != typeof document && document.getElementsByTagName && ((window.chrome && window.chrome.extension) || navigator.userAgent.match(/^Node\.js/) || (g = !0));
                    var v;
                })();
                var ne;
                s(function (e) {
                    return function () {
                        e.call(this),
                            (this.baseURL = J),
                            (this.map = {}),
                            "undefined" != typeof $__curScript && (this.scriptSrc = $__curScript.src),
                            (this.warnings = !1),
                ...
                i("locate", function (e) {
                    ...
                    i("import", function (e) {
                        return function (t, r, n) {
                            return (
                                r && r.name && w.call(this, "SystemJS.import(name, { name: parentName }) is deprecated for SystemJS.import(name, parentName), while importing " + t + " from " + r.name),
                ...
                (a.prototype.config = function (e, t) {
                    ...
                    var n = this;
                    if (
                        ("loaderErrorStack" in e && ((ie = $__curScript), e.loaderErrorStack ? ($__curScript = void 0) : ($__curScript = ie)),
                        "warnings" in e && (n.warnings = e.warnings),
                        e.transpilerRuntime === !1 && (n._loader.loadedTranspilerRuntime = !0),
                        ("production" in e || "build" in e) && j.call(n, !!e.production, !!(e.build || (ne && ne.build))),
                        !t)
                    ) {
                        var a;
                        if (
                    ...
                    if (
                        (e.defaultJSExtensions && ((n.defaultJSExtensions = e.defaultJSExtensions), w.call(n, "The defaultJSExtensions configuration option is deprecated, use packages configuration instead.")),
                        ...
                        for (var o in e.map) {
                            ...
                            if ("string" != typeof i) {
                                ...
                                var u = "";
                                for (var c in n.packages) l.substr(0, c.length) == c && (!l[c.length] || "/" == l[c.length]) && u.split("/").length < c.split("/").length && (u = c);
                    ...
                    if (e.packages)
                        for (var o in e.packages) {
                            ...
                            var l = M.call(n, o);
                            "/" == l[l.length - 1] && (l = l.substr(0, l.length - 1)), b(n, l, e.packages[o], !1);
                        }
                    for (var S in e) {
                        var i = e[S];
                        if (-1 == $.call(["baseURL", "map", "packages", "bundles", "paths", "warnings", "packageConfigPaths", "loaderErrorStack", "browserConfig", "nodeConfig", "devConfig", "buildConfig", "productionConfig"], S))
                            if ("object" != typeof i || i instanceof Array) n[S] = i;
                            else {
                                n[S] = n[S] || {};
                                for (var o in i)
                                    if ("meta" == S && "*" == o[0]) g((n[S][o] = n[S][o] || {}), i[o]);
                                    else if ("meta" == S) {
                                        var _ = M.call(n, o);
                                        n.defaultJSExtensions && ".js" != _.substr(_.length - 3, 3) && !d(_) && (_ += ".js"), g((n[S][_] = n[S][_] || {}), i[o]);
                                    } else if ("depCache" == S) {
                                        var s = n.defaultJSExtensions && ".js" != o.substr(o.length - 3, 3),
                                            l = n.decanonicalize(o);
                    ...
                    (function () {
                        function e(e, t) {
                            var r,
                                n,
                                a = 0;
                            for (var o in e.packages) t.substr(0, o.length) !== o || (t.length !== o.length && "/" !== t[o.length]) || ((n = o.split("/").length), n > a && ((r = o), (a = n)));
                            return r;
                        }
                        ...
                        function r(e, r, n, a, i) {
                            ...
                            if (r.map) {
                                var s = "./" + a,
                                    l = _(r.map, s);
                                if ((l || ((s = "./" + t(e, r, n, a, i)), s != "./" + a && (l = _(r.map, s))), l)) {
                                    var u = o(e, r, n, l, s, i);
                                    if (u) return u;
                                }
                            }
                        ...
                        function o(e, r, a, o, i, s) {
                            ...
                            if (n(o, l, a, i) && "string" == typeof l) {
                                if ("." == l) l = a;
                                else if ("./" == l.substr(0, 2)) return a + "/" + t(e, r, a, l.substr(2) + i.substr(o.length), s);
                        ...
                        function l(e, r, n, a, o) {
                            ...
                            var i, s;
                            return (
                                r.map && ((i = "./" + a), (s = _(r.map, i)), s || ((i = "./" + t(e, r, n, a, o)), i != "./" + a && (s = _(r.map, i)))),
                        ...
                        function d(e, t, r, a, o, i) {
                            ...
                            var s = t.map[a];
                            if ("string" == typeof s) return n(a, s, r, o) ? u(e, t, r, a, s, o, i) : Promise.resolve();
                            ...
                            return (
                                ...
                                n.load(r).then(function () {
                                    ...
                                    return (
                                        ...
                                        a.modules && ((a.meta = a.modules), w.call(e, "Package config file " + r + ' is configured with "modules", which is deprecated as it has been renamed to "meta".')),
                                        b(e, t, a, !0)
                                    );
                                })
                            );
                        ...
                        function p(e, t, r) {
                            ...
                            for (var a in e) {
                                var o = "./" == a.substr(0, 2) ? "./" : "";
                                if ((o && (a = a.substr(2)), (n = a.indexOf("*")), -1 !== n && a.substr(0, n) == t.substr(0, n) && a.substr(n + 1) == t.substr(t.length - a.length + n + 1) && r(a, e[o + a], a.split("/").length))) return;
                            }
                        ...
                        s(function (e) {
                            ...
                            i("decanonicalize", function (t) {
                                return function (r, n) {
                                    ...
                                    return (
                                        ...
                                        (s === !1 || (s && ".js" != s)) && ".js" != r.substr(r.length - 3, 3) && ".js" == a.substr(a.length - 3, 3) && (a = a.substr(0, a.length - 3)),
                                        a
                                    );
                                };
                            }),
                            i("normalizeSync", function (t) {
                                return function (n, a, i) {
                                    var s = this;
                                    if (((i = i === !0), a)) var l = e(s, a) || (s.defaultJSExtensions && ".js" == a.substr(a.length - 3, 3) && e(s, a.substr(0, a.length - 3)));
                    ...
                    (function () {
                        function t() {
                            ...
                            for (var e = 0; e < d.length; e++) if ("interactive" == d[e].script.readyState) return (s = d[e]), s.load;
                        }
                        function r(e, t) {
                        ...
                        i("pushRegister_", function (e) {
                            ...
                            i("fetch", function (t) {
                                return function (i) {
                                    var l = this;
                                    return "json" != i.metadata.format && i.metadata.scriptLoad && (D || F)
                                        ? F
                                            ? r(l, i)
                                            : new Promise(function (t, r) {
                                                  function m(e) {
                                                      if (!g.readyState || "loaded" == g.readyState || "complete" == g.readyState) {
                                                          if ((c--, i.metadata.entry || f.length)) {
                                                              if (!u) {
                                                                  for (var n = 0; n < f.length; n++) l.reduceRegister_(i, f[n]);
                                                                  f = [];
                                                              }
                                                  ...
                                                  function h() {
                                                      if (((e.System = a), (e.require = o), g.detachEvent)) {
                                                          ...
                                                          for (var t = 0; t < d.length; t++) d[t].script == g && (s && s.script == g && (s = null), d.splice(t, 1));
                                                      } else g.removeEventListener("load", m, !1), g.removeEventListener("error", p, !1);
                                                      n.removeChild(g);
                                                  }
                                                  var g = document.createElement("script");
                                                  (g.async = !0),
                                                      i.metadata.crossOrigin && (g.crossOrigin = i.metadata.crossOrigin),
                                                      i.metadata.integrity && g.setAttribute("integrity", i.metadata.integrity),
                                                      u ? (g.attachEvent("onreadystatechange", m), d.push({ script: g, load: i })) : (g.addEventListener("load", m, !1), g.addEventListener("error", p, !1)),
                                                      c++,
                                                      (a = e.System),
                                                      (o = e.require),
                                                      (g.src = i.address),
                ...
                !(function () {
                            ...
                            for (var a = 0, o = e.normalizedDeps.length; o > a; a++) {
                                ...
                                if (s && !s.evaluated) {
                                    ...
                                    if (null === s.groupIndex || s.groupIndex < l) {
                                        if (null !== s.groupIndex && (n[s.groupIndex].splice($.call(n[s.groupIndex], s), 1), 0 == n[s.groupIndex].length)) throw new Error("Mixed dependency cycle detected");
                                        s.groupIndex = l;
                                    }
                                    t(s, r, n);
                                }
                    ...
                    function c(t, n) {
                        if (!t.module) {
                            ...
                            void 0 !== f && (o.exports = f),
                                (a = o.exports),
                                a && (a.__esModule || a instanceof r) ? (t.esModule = n.newModule(a)) : t.esmExports && a !== e ? (t.esModule = n.newModule(p(a))) : (t.esModule = n.newModule({ default: a, __useDefault: !0 }));
                        }
                    }
                    function f(t, r, n, a) {
                        if (r && !r.evaluated && r.declarative) {
                            ...
                            for (var o = 0, i = r.normalizedDeps.length; i > o; o++) {
                                ...
                                -1 == $.call(n, s) && (a.defined[s] ? f(s, a.defined[s], n, a) : a.get(s));
                            }
                    ...
                    (a.prototype.register = function (e, t, r) {
                        ...
                        var n = R();
                        (n.name = e && (this.decanonicalize || this.normalize).call(this, e)), (n.declarative = !0), (n.deps = t), (n.declare = r), this.pushRegister_({ amd: !1, entry: n });
                    }),
                        (a.prototype.registerDynamic = function (e, t, r, n) {
                            "string" != typeof e && ((n = r), (r = t), (t = e), (e = null));
                            var a = R();
                            (a.name = e && (this.decanonicalize || this.normalize).call(this, e)), (a.deps = t), (a.execute = n), (a.executingRequire = r), this.pushRegister_({ amd: !1, entry: a });
                        }),
                            ...
                            return function (e, t) {
                                if (t) {
                                    ...
                                    if ((r.name && (r.name in this.defined || (this.defined[r.name] = r), n && (n.bundle = !0)), !r.name || (e && !n.entry && r.name == e.name))) {
                                        if (!n) throw new TypeError("Invalid System.register call. Anonymous System.register calls can only be made by modules loaded by SystemJS.import and not via script tags.");
                                        if (n.entry)
                                            throw "register" == n.format
                                                ? new Error("Multiple anonymous System.register calls in module " + e.name + ". If loading a bundle, ensure all the System.register calls are named.")
                                                : new Error("Module " + e.name + " interpreted as " + n.format + " module format, but called System.register.");
                        ...
                        i("instantiate", function (e) {
                            return function (t) {
                                ...
                                var r,
                                    a = this;
                                if (a.defined[t.name]) (r = a.defined[t.name]), r.declarative || (r.deps = r.deps.concat(t.metadata.deps)), (r.deps = r.deps.concat(t.metadata.deps));
                                    ...
                                    if (("undefined" != typeof re && re.call(a, t), !t.metadata.entry && !t.metadata.bundle)) throw new Error(t.name + " detected as " + t.metadata.format + " but didn't execute.");
                            ...
                            return function (i) {
                                ...
                                return o.apply(s, l).then(function (o) {
                                    if ("esm" == i.metadata.format || "es6" == i.metadata.format || (!i.metadata.format && o.match(r))) {
                                        if (
                                            ("es6" == i.metadata.format && w.call(s, "Module " + i.name + ' has metadata setting its format to "es6", which is deprecated.\nThis should be updated to "esm".'),
                                            (i.metadata.format = "esm"),
                                            i.metadata.deps)
                                        ) {
                                            for (var u = "", d = 0; d < i.metadata.deps.length; d++) u += 'import "' + i.metadata.deps[d] + '"; ';
                                            i.source = u + o;
                                        }
                                        if (s.transpiler === !1) {
                                        ...
                                        return (
                                            ...
                                            (
                                                ...
                                                (s._loader.transpilerPromise = Promise.resolve(
                                                    e["typescript" == s.transpiler ? "ts" : s.transpiler] ||
                                                        (s.pluginLoader || s).normalize(s.transpiler).then(function (e) {
                                                            return (
                                                                (s._loader.transpilerNormalized = e),
                                                                (s.pluginLoader || s).load(e).then(function () {
                                                ...
                                                function (t) {
                                                    return (
                                                        ...
                                                        "function" != typeof t["default"] || e["typescript" == s.transpiler ? "ts" : s.transpiler]
                                                            ? t.translate
                                                                ? t == i.metadata.loaderModule
                                                                    ? i.source
                                                                    : ("string" == typeof i.metadata.sourceMap && (i.metadata.sourceMap = JSON.parse(i.metadata.sourceMap)),
                                                                      Promise.resolve(t.translate.apply(s, l)).then(function (e) {
                                                                          var t = i.metadata.sourceMap;
                                                                          if (t && "object" == typeof t) {
                                                                              var r = i.address.split("!")[0];
                                                                              (t.file && t.file != i.address) || (t.file = r + "!transpiled"),
                                                                                  (!t.sources || (t.sources.length <= 1 && (!t.sources[0] || t.sources[0] == i.address))) && (t.sources = [r]);
                                                                          }
                                                                          return "esm" == i.metadata.format && !s.builder && k(e) && (i.metadata.format = "register"), e;
                                                                      }))
                                                                : (s.builder && (i.metadata.originalSource = i.source),
                                                                  Y.call(s, i).then(function (e) {
                                                                      return (i.metadata.sourceMap = void 0), e;
                                                                  }))
                                                            : s.builder
                                                            ? o
                                                            : Promise.resolve(t["default"].call(s, i.address, i.name)).then(function (e) {
                                                                  return x(i, e), "";
                                                              })
                                                    );
                                                },
                                    ...
                                    if (
                                        (s._loader.loadedTranspiler !== !1 ||
                                            ...
                                            (o.length > 100 &&
                                                !i.metadata.format &&
                                                ((i.metadata.format = "global"), "traceur" === s.transpiler && (i.metadata.exports = "traceur"), "typescript" === s.transpiler && (i.metadata.exports = "ts")),
                                            (s._loader.loadedTranspiler = !0)),
                                        s._loader.loadedTranspilerRuntime === !1 &&
                                            (i.name == s.normalizeSync("traceur-runtime") || i.name == s.normalizeSync("babel/external-helpers*")) &&
                                            (o.length > 100 && (i.metadata.format = i.metadata.format || "global"), (s._loader.loadedTranspilerRuntime = !0)),
                                        ("register" == i.metadata.format || i.metadata.bundle) && s._loader.loadedTranspilerRuntime !== !0)
                                    ) {
                ...
                i("fetch", function (e) {
                    ...
                    i("reduceRegister_", function (e) {
                        return function (t, r) {
                            if (r || (!t.metadata.exports && (!F || "global" != t.metadata.format))) return e.call(this, t, r);
                    ...
                    (function () {
                        function t(e) {
                            ...
                            var r,
                                ...
                                l = [];
                            if (e.length / e.split("\n").length < 200) {
                                for (; (r = o.exec(e)); ) s.push([r.index, r.index + r[0].length]);
                                for (; (r = a.exec(e)); ) t(s, r) || l.push([r.index + r[1].length, r.index + r[0].length - 1]);
                            }
                            for (; (r = n.exec(e)); )
                                if (!t(s, r) && !t(l, r)) {
                    ...
                    s(function (e) {
                        return function () {
                            ...
                            var r = this;
                            if ((e.call(r), "undefined" != typeof window && "undefined" != typeof document && window.location)) var n = location.protocol + "//" + location.hostname + (location.port ? ":" + location.port : "");
                            r.set(
                                "@@cjs-helpers",
                                r.newModule({
                        ...
                        return function () {
                            ...
                            function a(t, a, i) {
                                ...
                                "string" != typeof t && ((i = a), (a = t), (t = null)),
                                    a instanceof Array || ((i = a), (a = ["require", "exports", "module"].splice(0, i.length))),
                                    "function" != typeof i &&
                                        (i = (function (e) {
                                            return function () {
                                                return e;
                                ...
                                var l, u, d;
                                -1 != (l = $.call(a, "require")) && (a.splice(l, 1), t || (a = a.concat(r(i.toString(), l)))), -1 != (u = $.call(a, "exports")) && a.splice(u, 1), -1 != (d = $.call(a, "module")) && a.splice(d, 1);
                                var c = R();
                                (c.name = t && (o.decanonicalize || o.normalize).call(o, t)), (c.deps = a), (c.execute = s), o.pushRegister_({ amd: !0, entry: c });
                            }
                            var o = this;
                            t.call(this);
                            var s = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm,
                            ...
                            (a.amd = {}),
                                i("reduceRegister_", function (e) {
                                    return function (t, r) {
                                        ...
                                        if (a.name) n && (n.entry || n.bundle ? n.entry && n.entry.name && n.entry.name != t.name && (n.entry = void 0) : (n.entry = a), (n.bundle = !0)), a.name in this.defined || (this.defined[a.name] = a);
                                        else {
                    ...
                    (function () {
                        ...
                        function t(e, t) {
                            var r,
                                n,
                                a = t.lastIndexOf("!");
                            return -1 != a ? (e.pluginFirst ? ((r = t.substr(a + 1)), (n = t.substr(0, a))) : ((r = t.substr(0, a)), (n = t.substr(a + 1) || r.substr(r.lastIndexOf(".") + 1))), { argument: r, plugin: n }) : void 0;
                        }
                        function n(e, t, r, n) {
                        ...
                        i("decanonicalize", o),
                            ...
                            i("normalize", function (r) {
                                return function (o, i, s) {
                                    ...
                                    var u = t(l, o);
                                    return u
                                        ? Promise.all([l.normalize(u.argument, i, !0), l.normalize(u.plugin, i, !1)]).then(function (e) {
                                    ...
                                    return (
                                        ...
                                        e
                                            ...
                                            .then(function (e) {
                                                ...
                                                if (!r) return e;
                                                if (t.name == r) throw new Error("Plugin " + r + " cannot load itself, make sure it is excluded from any wildcard meta configuration via a custom loader: false rule.");
                            ...
                            i("fetch", function (e) {
                                return function (t) {
                                    var n = this;
                                    if (t.metadata.loaderModule && "defined" != t.metadata.format) {
                                        if ("function" == typeof t.metadata.loaderModule || (t.metadata.loaderModule instanceof r && "function" == typeof t.metadata.loaderModule["default"])) return "";
                                        if (((t.metadata.scriptLoad = !1), t.metadata.loaderModule.fetch))
                                            return t.metadata.loaderModule.fetch.call(n, t, function (t) {
                                                return e.call(n, t);
                                            });
                                    }
                                    return e.call(n, t);
                            ...
                            i("instantiate", function (e) {
                                return function (t) {
                                    var n = this,
                                        a = !1;
                                    if (t.metadata.loaderModule && !n.builder && "defined" != t.metadata.format) {
                                        if (t.metadata.loaderModule.instantiate)
                                            return Promise.resolve(
                                                t.metadata.loaderModule.instantiate.call(n, t, function (t) {
                                                    if (a) throw new Error("Instantiate must only be called once.");
                                        ...
                                        if ("function" == typeof t.metadata.loaderModule || (t.metadata.loaderModule instanceof r && "function" == typeof t.metadata.loaderModule["default"]))
                                            return Promise.resolve((t.metadata.loaderModule["default"] || t.metadata.loaderModule).call(n, t.address, t.name)).then(function (r) {
                ...
                i("normalize", function (e) {
                                        ...
                                        if ((";" == l.substr(u - 1, 1) && u--, '"' == d || "'" == d)) {
                                            ...
                                            if (f) {
                                                ...
                                                "[]" == f.substr(f.length - 2, 2)
                                                    ...
                                                    ? (w.call(this, "Module " + a.name + ' contains deprecated "deps ' + m + '" meta syntax.\nThis should be updated to "deps[] ' + m + '" for pushing to array meta.'), a.metadata[f].push(m))
                                                    : e(a.metadata, f, m);
                                            } else a.metadata[c] = !0;
                                        }
                                    }
                                            ...
                                            for (var o = 0; o < r.bundles[a].length; o++) {
                                                ...
                                                if (-1 != i.indexOf("*")) {
                                                    ...
                                                    if (
                                                        ...
                                                        t.name.substr(t.name.length - s[1].length, s[1].length) == s[1] &&
                                                        -1 == t.name.substr(s[0].length, t.name.length - s[1].length - s[0].length).indexOf("/")
                                                    ) {
                                                        n = !0;
                                                        break;
                                                    }
                    ...
                    (Z = new a()),
                    (e.SystemJS = Z),
                    (Z.version = "0.19.47 Standard"),
                    "object" == typeof module && module.exports && "object" == typeof exports && (module.exports = Z),
                    (e.System = Z);
            })("undefined" != typeof self ? self : global);
    }
